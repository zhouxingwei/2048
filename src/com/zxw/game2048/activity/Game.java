package com.zxw.game2048.activity;
...
import com.zxw.game2048.view.GameView;
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0,
                                ...
                                if (!TextUtils.isEmpty(et.getText())) {
                                    mGameView.addSuperNum(Integer.parseInt(et
                                            .getText().toString()));
                                    mGameView.checkCompleted();
                                }
                            }
                        })
